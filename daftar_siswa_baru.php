	        ...
	        <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
				...
				<div class="card" style="margin-top: 50px">
                    <div class="card-header" data-background-color="blue">
                        ...
                        <p class="category">Isi Form pendaftaran Sesuai Ijazah & KK</p>
                    </div>
                    <div class="card-content">
                        <form method="post" action="">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <select name="agama_mhs" class="form-control">
                                        	...
                                        	<option value="islam" <?php isset($_SESSION['agama_mhs']) && $_SESSION['agama_mhs'] == "islam" ? print("selected") : "" ?>>Islam</option>
                                        	<option value="hindu" <?php isset($_SESSION['agama_mhs']) && $_SESSION['agama_mhs'] == "hindu" ? print("selected") : "" ?>>Hindu</option>
                                            <option value="budha" <?php isset($_SESSION['agama_mhs']) && $_SESSION['agama_mhs'] == "budha" ? print("selected") : "" ?>>Budha</option>
                                            <option value="kristen" <?php isset($_SESSION['agama_mhs']) && $_SESSION['agama_mhs'] == "kristen" ? print("selected") : "" ?>>Kristen</option>
                                            <option value="katolik" <?php isset($_SESSION['agama_mhs']) && $_SESSION['agama_mhs'] == "katolik" ? print("selected") : "" ?>>Katolik</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['no_hp'])  ?  print($_SESSION['no_hp']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        value="<?php isset($_SESSION['tinggi_badan'])  ?  print($_SESSION['tinggi_badan']) : ""; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        value="<?php isset($_SESSION['berat_badan'])  ?  print($_SESSION['berat_badan']) : ""; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Alamat <i>(Sesuai KTP)</i></label>
                                        <input type="text" class="form-control" name="alamat_mhs" 
										value="<?php isset($_SESSION['alamat_mhs'])  ?  print($_SESSION['alamat_mhs']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Asal Sekolah</i></label>
                                        <input type="text" class="form-control" name="asal_sekolah_mhs" 
										value="<?php isset($_SESSION['asal_sekolah_mhs'])  ?  print($_SESSION['asal_sekolah_mhs']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Alamat Sekolah</i></label>
                                        <input type="text" class="form-control" name="alamat_sekolah_mhs" 
										value="<?php isset($_SESSION['alamat_sekolah_mhs'])  ?  print($_SESSION['alamat_sekolah_mhs']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Di Pekanbaru ikut</label>
