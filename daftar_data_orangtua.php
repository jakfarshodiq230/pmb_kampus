	        ...
	        <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
				...
				<div class="card" style="margin-top: 50px">
                    <div class="card-header" data-background-color="blue">
                        ...
                        <p class="category">Isi Form pendaftaran KK & KTP</p>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        value="<?php isset($_SESSION['birth_date_father'])  ?  print($_SESSION['birth_date_father']) : print("1980-01-01"); ?>"required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="no_hpayah" 
                                        value="<?php isset($_SESSION['no_hpayah'])  ?  print($_SESSION['no_hpayah']) : ""; ?>"
