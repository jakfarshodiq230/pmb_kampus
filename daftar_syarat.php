            ...
            <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
                <div class="card" style="margin-top: 50px">
                    ...
                    <div class="card-content">
                        <h4>Berikut adalah syarat pendaftaran mahasiswa baru yang harus dipenuhi :</h4>
                        <ol>
                            <li><font color="#2ecc71">Mengisi Formulir Pendaftaran <i class="fa fa-check"></font></i></li>
                            <li>Upload Foto 4X6 <i>(JPG)</i></li>
                            <li>Upload Ijazah/SKL, KK, & KTP </li>
                            <li>Upload Surat Keterangan Kelakuan Baik </li>
                            <li>Upload Surat Keterangan TIDAK HAMIL </li>
                        </ol>

                        <h6><i><b>*Catatan : Berkas akan di upload ke sistem setelah pendaftran diverifikasi ( 2 x 24 jam), untuk pesyaratan no 3 sampai 5 di jadikan satu file pdf.</b></i></h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
                <div class="card" style="margin-top: 50px">
                    <div class="card-header" data-background-color="blue">
                        ...
                        <p class="category">Periksan data anda dibawah, pastikan sudah benar dan sama dengan Ijazah, KK, dan KTP</p>
                    </div>
                    <div class="card-content table-responsive">
                        
                        <a href="daftar_siswa_baru.php" class="btn btn-primary pull-right" ><i class="fa fa-pencil"></i> Edit Data</a>
                        <h3 style="overflow: hidden;"><b>Data Calon Mahasiswi</b></h3>
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Agama</b></td>
                                    <td>: <?php isset($_SESSION['agama_mhs'])  ?  print($_SESSION['agama_mhs']) : ""; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>: <?php isset($_SESSION['tinggi_badan'])  ?  print($_SESSION['tinggi_badan']." CM") : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Berat Badan</b></td>
                                    <td>: <?php isset($_SESSION['berat_badan'])  ?  print($_SESSION['berat_badan']." Kg") : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Telp/HP</b></td>
                                    <td>: <?php isset($_SESSION['no_hp'])  ?  print($_SESSION['no_hp']) : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Alamat KTP</b></td>
                                    <td>: <?php isset($_SESSION['alamat_mhs'])  ?  print($_SESSION['alamat_mhs']) : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Asal Sekolah</b></td>
                                    <td>: <?php isset($_SESSION['asal_sekolah_mhs'])  ?  print($_SESSION['asal_sekolah_mhs']) : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Alamat Sekolah</b></td>
                                    <td>: <?php isset($_SESSION['alamat_sekolah_mhs'])  ?  print($_SESSION['alamat_sekolah_mhs']) : ""; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Telp/HP</b></td>
                                    <td>: <?php isset($_SESSION['no_hp'])  ?  print($_SESSION['no_hp']) : ""; ?></td>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Telp/HP</b></td>
                                    <td>: <?php isset($_SESSION['no_hpayah'])  ?  print($_SESSION['no_hpayah']) : ""; ?></td>
                                </tr>
                        ...
                        <hr>
                        <i><h4>* Anda yakin data diatas, sudah benar?</h4></i>
